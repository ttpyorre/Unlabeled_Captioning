...
text_autoencoder_path = 'stored_model_dir/AutoEncoderDglove100_flowerFalse11.pt' #'//home/das/dev/unsup/saved_models/flowers/AutoEncoderDglove100_flowerFalse203.pt' # text auto encoder
...
def define_optimizers(netGIT, netDIT,netGTI, netDTI, path):
    ...
    optimizerDTI = optim.RMSprop(netDTI.parameters(), lr=5e-5) # lr 5e-5
    ...
    #optimizerGTI = optim.Adam(netGTI.parameters(),
     #                       lr=cfg.TRAIN.GENERATOR_LR,
      #                      betas=(0.5, 0.999))
    optimizerGTI = optim.RMSprop(netGTI.parameters(), lr=5e-5) # lr 5e-5
    ...
    def evaluate(self):
        ...
        for uinputs, inputs,_, labels, captions, lengths in self.dataloaders['val']:
            ...
            ###############We can use original image or output of image decoder#############
                ...
                score2 = corpus_bleu([references], [candidates], smoothing_function=chencherry.method1)
                score3 = sentence_bleu(references, texts_o, smoothing_function=chencherry.method1)
                score4 = corpus_bleu([references], [texts_o], smoothing_function=chencherry.method1)
                print("score")
                print(score)
                print(score2)
                print(score3)
